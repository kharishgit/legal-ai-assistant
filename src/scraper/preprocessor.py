...
def is_ipc302_relevant(text):
    ...
    keywords = ["ipc 302", "section 302", "murder under 302"]
...
def preprocess_indiacode_data(input_dir="data/raw/indiacode", output_file="data/processed/indiacode_processed.json"):
    """
    Preprocess India Code JSON files.
    Args:
...
def preprocess_indiankanoon_data(input_dir="data/raw/", output_file="data/processed/indiankanoon_processed.json"):
    """
